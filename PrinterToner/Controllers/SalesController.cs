...
namespace PrinterToner.Controllers
{
    public class SalesController : Controller
    {
        ...
        {
            var sales = db.Sales.Include(s => s.Owner).Include(s => s.Printer).Include(s => s.Toner);
        ...
        public ActionResult Create([Bind(Include = "SaleID,SaleDate,a,OwnerID,PrinterID,TonerID")] Sale sale)
        {
            ...
            ViewBag.OwnerID = new SelectList(db.Owners, "OwnerID", "OwnerName", sale.OwnerID);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SaleID,SaleDate,a,OwnerID,PrinterID,TonerID")] Sale sale)
        {
            if (ModelState.IsValid)
            {
